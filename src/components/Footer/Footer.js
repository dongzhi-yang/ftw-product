              ...
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    name="SearchPage"
                    to={{
                      search: '?pub_brand=Mercedes-Benz',
                    }}
                    className={css.link}
                  >
